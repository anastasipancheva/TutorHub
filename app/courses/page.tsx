...
const programs = [
  ...
  },
  {
    ...
    description: "Узнай все про времена сразу же на практике + Задай все интересующие вопросы преподавателю",
          ...
          <section className="py-16">
            <div className="mb-8">
              <h2 className="text-3xl font-bold text-center mb-4">
                Все наши <span className="text-brand-pink-bright">{programs.length}</span> программы
              </h2>
